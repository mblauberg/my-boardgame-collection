...
export function PublicCollectionPage() {
  ...
  if (isLoading) {
    return <div className="p-8 text-center">Loading public collection...</div>;
  }

  if (error || !data) {
    return <div className="p-8 text-center">Public collection not found.</div>;
  }

  return (
    <section className="space-y-8">
      <header className="space-y-3">
        <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Public collection</p>
